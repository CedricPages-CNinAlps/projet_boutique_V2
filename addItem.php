...
<head>
    ...
    <meta name="description" content="Page ajout produit via formulaire">
    <meta name="author" content="Cedric Pages">
    <meta name="generator" content="Titi">
    <title>Ajout produit au catalogue</title>
    ...
    <div class="navbar navbar-dark bg-dark shadow-sm">
        <div class="container d-flex justify-content-between">
            <a href="#" class="navbar-brand d-flex align-items-center">
                <svg xmlns="http://www.w3.org/2000/svg" id="svg" width="20" height="20" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" aria-hidden="true" class="mr-2" viewBox="0 0 24 24" focusable="false"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>
...
<main role="main">
    ...
    <div class="container">
        <div class="py-5 text-center">
            <h2>Procédure d'ajout d'un nouveau produit au catalogue</h2>
            <p class="lead">Merci de suivre les étape suivantes :</p>
        </div>
        ...
        <div class="row">
            <div class="col-md-8 order-md-1">
                ...
                <form action="displayItem.php" method="POST" enctype="multipart/form-data">
                    ...
                    <hr class="mb-4">
                    <button class="btn btn-primary btn-lg btn-block" type="submit">Envoyer le formulaire</button>
